        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="official_login.php">Head Login</a></li>
                    <li><a href="headHome.php">Head Home</a></li>
                </ul>

                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="police_station_add.php">Add Police Station</a></li>
                ...
                <div class="login-form">
                    ...
                    <form method="post" style="color: gray">Police Station Location
                        ...
                        <input type="text" name="incharge_name" placeholder="Incharge Name" required="" id="iname"
                            onfocusout="f1()" />
                        Incharge ID<input type="text" name="incharge_id" placeholder="Incharge ID" required="" id="iid"
                            onfocusout="f1()" />
                        <br>
                        Password<input type="text" name="password" placeholder="Password" required="" id="pas"
                            onfocusout="f1()" />
